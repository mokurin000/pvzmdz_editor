...
class GameData {
  ...
  GameData copyWith({
    List<int>? scores,
    List<ShopItem>? shangdian,
    List<bool>? shangdianYishou,
    List<int>? scores2,
    double? music,
    double? sf,
    ...
    bool? sskabao,
    bool? canbaohusan,
    List<int>? shangdianyigong,
    List<int>? pospos,
    List<int>? dates,
    List<String>? playerNames,
    List<int>? CustomZombieList,
    List<int>? CustomSpawnNumber,
  }) {
    return GameData(
      scores: scores ?? this.scores,
      shangdian: shangdian ?? this.shangdian,
      shangdianYishou: shangdianYishou ?? this.shangdianYishou,
      scores2: scores2 ?? this.scores2,
      music: music ?? this.music,
      sf: sf ?? this.sf,
      Difficulty: Difficulty ?? this.Difficulty,
      Maoxian: Maoxian ?? this.Maoxian,
      MaoxianIFA: MaoxianIFA ?? this.MaoxianIFA,
      MaoxianSnow: MaoxianSnow ?? this.MaoxianSnow,
      heng: heng ?? this.heng,
      shu: shu ?? this.shu,
      quanping: quanping ?? this.quanping,
      chuizhitongbu: chuizhitongbu ?? this.chuizhitongbu,
      pingban: pingban ?? this.pingban,
      wujinceng: wujinceng ?? this.wujinceng,
      wujinceng2: wujinceng2 ?? this.wujinceng2,
      wujinceng2Last: wujinceng2Last ?? this.wujinceng2Last,
      wujinceng3: wujinceng3 ?? this.wujinceng3,
      kcZheDang: kcZheDang ?? this.kcZheDang,
      hpShow: hpShow ?? this.hpShow,
      treeVanishOff: treeVanishOff ?? this.treeVanishOff,
      coin: coin ?? this.coin,
      chushisun: chushisun ?? this.chushisun,
      maoliang: maoliang ?? this.maoliang,
      coinYingtao: coinYingtao ?? this.coinYingtao,
      sunPokeCishu: sunPokeCishu ?? this.sunPokeCishu,
      zmPokeCishu: zmPokeCishu ?? this.zmPokeCishu,
      tianjianglihe: tianjianglihe ?? this.tianjianglihe,
      touzi: touzi ?? this.touzi,
      touzi2: touzi2 ?? this.touzi2,
      liekabao: liekabao ?? this.liekabao,
      ptkabao: ptkabao ?? this.ptkabao,
      xykabao: xykabao ?? this.xykabao,
      sskabao: sskabao ?? this.sskabao,
      canbaohusan: canbaohusan ?? this.canbaohusan,
      shangdianyigong: shangdianyigong ?? this.shangdianyigong,
      pospos: pospos ?? this.pospos,
      dates: dates ?? this.dates,
      playerNames: playerNames ?? this.playerNames,
      CustomZombieList: CustomZombieList ?? this.CustomZombieList,
      CustomSpawnNumber: CustomSpawnNumber ?? this.CustomSpawnNumber,
    );
  }
}
